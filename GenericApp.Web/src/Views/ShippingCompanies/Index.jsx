        ...
        <Box>
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        <Typography variant="h6" sx={{ fontWeight: 700, lineHeight: 1.2 }}>{t('shippingCompanies')}</Typography>
                        <Typography variant="caption" color="text.secondary" sx={{ display: { xs: 'none', sm: 'block' } }}>
                            {t('shippingCompanies_description')}
                        </Typography>
                    </Box>
                </Box>
            ...
            {isSmallScreen ? <ShippingCompanyCardList {...commonListProps} /> : <ShippingCompanyListTable {...commonListProps} />}
